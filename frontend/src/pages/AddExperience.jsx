...
export default function AddExperience() {
  ...
  const handleSubmit = () => {
    if (!formData.company || !formData.role || !formData.difficulty) {
      alert("Please fill at least company, role and difficulty.");
      return;
    }
      ...
      <Box sx={{ p: 4 }}>
        <Card sx={{ p: 4, boxShadow: 3 }}>
          ...
          <CardContent>
            ...
            {/* Interview Rounds */}
            <TextField
              label="Interview Rounds (Describe each round)"
              name="rounds"
              fullWidth
              multiline
              rows={3}
            ...
            {/* Tips */}
            <TextField
              label="Your Tips for Other Students"
              name="tips"
              fullWidth
              multiline
              rows={3}
